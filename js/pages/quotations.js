  ...
  document.getElementById('quotations-page').innerHTML = `
    <div class="page-header">
      ...
      <div class="flex gap-8">
        ...
        <button class="btn btn-primary" onclick="saveQuotation(${quoteId})">💾 Save Quotation</button>
      </div>
    </div>
    ...
    <div class="card mt-20" style="margin-top:20px;">
      <div class="card-header">
        ...
        <div class="flex gap-8">
          ...
          <button class="btn btn-primary btn-sm" onclick="addLineItem()">+ Add Row</button>
        </div>
      </div>
    ...
    <div class="grid grid-2 mt-20" style="margin-top:20px;">
      <div class="form-group">
        ...
        <textarea class="form-control" id="q-notes" rows="4" placeholder="${settings.defaults.invoiceNotes || 'Thank you for your business!'}">${quote?.notes || ''}</textarea>
      </div>
...
Object.assign(window.KwezaPages, {
  ...
  saveQuotation, convertQuote, deleteQuote
});
